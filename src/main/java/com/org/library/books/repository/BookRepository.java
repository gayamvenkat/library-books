...
public interface BookRepository extends JpaRepository<Book, Long>, JpaSpecificationExecutor<Book> {
	...
	@Query("SELECT distinct  b FROM Book b  join b.tags tag WHERE (:isbn is null or b.isbn = :isbn ) or b.author = :author or b.title = :title or tag.name = :tags")
	...
	List<Book> findAllBooksAND(@Param("isbn") Long isbn, @Param("author") String author, @Param("title") String title,
			@Param("tags") String tags);
